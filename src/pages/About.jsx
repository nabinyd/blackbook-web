...
function About() {
    return (
        <div className="about bg-background-color text-white">
            <div className='h-screen w-9/12 mx-auto flex items-center'>


                <div className='Logo w-1/3'>
                    <img src={AboutUsIcon} alt="About us logo" className='h-60 w-60' />
                </div>
