...
export default function SignupPage() {
    const { handleRegister, isUserLoggedIn } = useContext(UserserviceContext);
    ...
    return (
        <div className='bg-background-color h-screen'>
            <div className='w-9/12 mx-auto flex items-center mt-7'>
                ...
                <div className='w-full  text-white'>
                    <div className=' flex flex-col items-end'>
                        ...
                        <form className='w-2/4 mt-10'>
                            ...
                            <button type='submit' onClick={handleSignup} className='w-full bg-blue-500 hover:bg-blue-600 text-white font-medium text-sm rounded-md px-3 py-2 focus:outline-none'>Sign up</button>
