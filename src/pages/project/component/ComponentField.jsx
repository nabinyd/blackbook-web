    ...
    return (
        <div className='mb-8'>
            ...
            <div className='flex items-center'>
                ...
                />
                <button onClick={handleAddComponent} className='bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-md px-3 py-1.5 focus:outline-none ml-2 text-nowrap' >Add </button>
            </div>
